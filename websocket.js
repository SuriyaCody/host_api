...
function connectModbusAndReadData() {
  modbusClient
    ...
    .catch((err) => {
      ...
      setTimeout(connectModbusAndReadData, 1000); // Retry connection after 1 second
    });
}
...
// Add error event listener for WebSocket server
wss.on("error", (error) => {
  console.error("WebSocket server error:", error);
});

connectModbusAndReadData();
